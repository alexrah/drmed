	...
	function atp_social() {
		if (get_option('atp_social_bookmark') != '') {
			...
			for ($i=0; $i<count($sys_social_bookmark_icons); $i++) {
				...
				$out .= '<li style="background:'.$sys_social_bookmark_icon[0].'"><a href="'.$sys_social_bookmark_icon[2].'">';
				$out .= '<img src="'.THEME_URI.'/images/sociables/'.$sys_social_bookmark_icon[1].'" alt=""  /> </a></li>';
