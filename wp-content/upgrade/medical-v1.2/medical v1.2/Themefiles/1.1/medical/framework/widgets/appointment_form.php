	...
	class reservation_widget extends WP_Widget {
		...
		function reservation_widget() {
			...
			$widget_ops = array( 
				...
				'description'	=> __('Booking Reservation Widget for Sidebar or any Widgetized Area.', 'atp_admin')
			);
			...
			// Create the widget.
			$this->WP_Widget('reservation_widget', THEMENAME.' - reservation Form', $widget_ops, $control_ops );
		}
		...
		function widget($args,$instance) {
			...
			$reservationtitle	="Doctor reservation";
			$before_widget	='<div id="reservation_widget" class="syswidget">';
			...
			<div id="reservationbox">
				...
				<form id="reservationform" action="<?php echo esc_url(get_permalink($reservation_pageid)); ?>" method="post">
					...
					<p class="center"><button class="button medium green" onclick="showHint()"><span><?php echo get_option('atp_reservationformtxt') ? get_option('atp_reservationformtxt') :'Take reservation'; ?></span></button><label id="load"></label></p>
					<div class="clear"></div>
				</form>
			</div>
<?php
