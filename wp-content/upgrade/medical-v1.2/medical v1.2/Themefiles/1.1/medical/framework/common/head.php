<?php
	...
	function enqueue_scripts() {
		...
		wp_register_script('jquery-gmap', 'http://maps.google.com/maps/api/js?sensor=false');
		...
		wp_register_script('atp-showslider-tmpl', THEME_JS .'/jquery.tmpl.min.js','jquery','','');
		wp_register_script('atp-showslider', THEME_JS .'/jquery.slideshow.js','atp-showslider-tmpl','','');
		wp_register_script('jquery_flex', THEME_JS .'/jquery.flexslider-min.js', 'jquery');	
		wp_register_script('atp-datepicker', THEME_URI .'/framework/admin/js/jquery.datepicker.js','jquery','','');
		...
		//wp_enqueue_style( 'responsive-style' );
			wp_enqueue_style('appointment-style', THEME_URI.'/framework/admin/css/pepper-grinder/jquery-ui-1.8.16.custom.css', false, false, 'all');
