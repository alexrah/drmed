	...
	function atp_social() {
		if (get_option('atp_social_bookmark') != '') {
			...
			for ($i=0; $i<count($sys_social_bookmark_icons); $i++) {
				...
				$out .= '<li><a href="'.$sys_social_bookmark_icon[2].'" style="background:'.$sys_social_bookmark_icon[0].'">';
				$out .= '<img src="'.get_template_directory_uri().'/images/sociables/'.$sys_social_bookmark_icon[1].'" alt=""  /> </a></li>';
