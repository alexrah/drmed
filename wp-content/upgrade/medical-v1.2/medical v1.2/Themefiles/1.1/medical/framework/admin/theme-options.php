	...
	if (!function_exists('atp_options')) {
		...
		function atp_options(){
			...
			$options[] = array( 'name'	=> 'Color',
					...
					$options[] = array( 'name'	=> 'Color Customization',
										'desc'	=> __('Make sure you check the box "Enable Custom Typography" in Typography below editing the below section', 'ATP_ADMIN_SITE'),
										'type'	=> 'subsection');
					...
					$options[] = array( 'name'	=> 'Enable Custom Skinning',
										'desc'	=> __('Check this if you wish to create your own custom skinning for the typography and colors which will overide the default css and enables the below customization and other colors','ATP_ADMIN_SITE'),
...
$options[] = array( 'name'	=> 'Top Menu',
										'desc'	=> __('Primary Menu which appears in topbar above the logo<br><br>Make sure you check the box "Enable Custom Typography" in Typography below editing the below section', 'ATP_ADMIN_SITE'),
										'type'	=> 'subsection');
					...
					$options[] = array( 'name'	=> 'Secondary Menu',
										'desc'	=> __('Secondary Menu which appears beside the logo', 'ATP_ADMIN_SITE'),
										'type'	=> 'subsection');
					...
					$options[] = array( 'name'	=> 'Link Colors',
										'desc'	=> __('Link colors for various sections of the theme.', 'ATP_ADMIN_SITE'),
										'type'	=> 'subsection');
					...
					$options[] = array( 'name'	=> 'Typography',
										'desc'	=> __('Custom font and typography customization for the various sections of the theme.', 'ATP_ADMIN_SITE'),
										'type'	=> 'subsection');
					...
					$options[] = array( 'name'	=> 'Custom CSS',
										'desc'	=> __('Quickly add some CSS without editing the default css.', 'ATP_ADMIN_SITE'),
										'type'	=> 'subsection');
			...
			*/
			...
			$options[] = array( 'name'	=> 'Language',
					...
					$options[] = array( 'name'	=> '404 Page',
										...
										'inputsize'=> '');
					// SUBSECTION------------------------------------------------------------------------------------------
					$options[] = array( 'name'	=> 'Appointment Form',
										'desc'	=> __('Custom localization for the appointment form page and widget.', 'ATP_ADMIN_SITE'),
										'type'	=> 'subsection');
					// SUBSECTION------------------------------------------------------------------------------------------
					...
					$options[] = array( 'name'	=> 'Business Hours',
										'desc'	=> __('Custom localization for the business hours widget.', 'ATP_ADMIN_SITE'),
										'type'	=> 'subsection');
					// SUBSECTION------------------------------------------------------------------------------------------
		...
		// *******************************************************************//
		// ***** Hospital Email Setup
		// *******************************************************************//
		$options[] = array( 'name'	=> 'E-mails Setup',
							'icon'	=> $url.'email-setup-icon.png',
							'type'	=> 'heading');
