<?php
	...
	function sys_divider( $atts, $content = null ) {
		return '<div class="divider"><figure><img src="'.get_template_directory_uri().'/images/separator.png"></figure></div>';
	}
	...
	extract(shortcode_atts(array(
		...
		return '<div class="divider_top back-top"><a href="#top">'.do_shortcode($content).'</a></div>';
	}
