...
;(function($){
	...
	$.fn.extend({
		hideSuperfishUl : function(){ 
			...
			$ul.find('>ul').animate(o.animationClose, 
			o.speed, 
			function() { 
		...
		showSuperfishUl : function(){ 
			...
			o.onBeforeShow.call($ul); 
			$ul.animate(o.animationOpen,o.speed,o.easing,
			function(){ o.onShow.call(this); 
			}); return this; 
		}
	});
	...
	$(document).ready(function() {
		...
		$(".sf-menu li li a").hover(function() {
		    ...
		    $(this).parent().find("span").stop().animate({ marginLeft: "5px", opacity: 0.25 }, 200);
		},function(){
