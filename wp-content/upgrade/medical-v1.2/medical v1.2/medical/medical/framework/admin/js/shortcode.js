		...
		generate:function(){
			...
			switch(type){
				...
				case 'Boxes':
						...
						switch(shortcodesub_type) {
							...
							case 'fancybox':
									...
									return '\n[fancy_box'+title+titlebgcolor+titlecolor+ribbon+']'+ text +'[/fancy_box]\n';
									break;
							// S P E C I A L   B O X 
							//--------------------------------------------------------
							case 'specialbox':
				...
				case 'chart':
						...
						var width = jQuery('[name="chart_width"]').val();
						var height = jQuery('[name="chart_height"]').val();
						var extras = jQuery('[name="chart_extras"]').val();
						var advanced = jQuery('[name="chart_advanced"]').val();
						var type = jQuery('[name="chart_type"]').val();
						var chart_content = jQuery('[name="chart_content"]').val();
						if(title!='')	{ title =' title="'+title+'"';}
						if(width!='')	{ width =' width="'+width+'"';	}
						if(height!='')	{ height =' height="'+height+'"';	}
						if(extras!=''){ extras =' extras="'+extras+'"';}
						if(type!='')	{ type =' type="'+type+'"';}
							if(chart_content !="") {content = ''+chart_content+'';}
						return '\n[chart'+title+width+height+extras+type+']'+ content+'[/chart]\n';;
						break;
				// W I D G E T S 
				//--------------------------------------------------------
				case 'widgets':
