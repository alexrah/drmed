...
<div class="pagemid clearfix">
	...
	<!-- #B R E A D C R U M B S -->
			...
			echo '<figure>';
			echo atp_resize($post->ID,'',$width,'300','imgborder','');
			echo '</figure>';
			}
			...
			echo '<span class="doctor-title">'.get_the_title().'<em>'.$specialist.'</em></span>';
			echo '<p class="center">'.wp_html_excerpt(get_the_excerpt(''), 150).'</p>';
			echo '<p class="center"><a  class="button small" href="'.get_permalink() . '"><span>'.$atp_viewprofiletxt.'</span></a></p>';
			echo '</div></div>';
